...
**Status:** Delivered in Phase 4c (quantity/`none`); extended in 4d (individual) and 4e (linked returns)  
**Type:** Record-level workflow  
**Governing:** ADR-0008, ADR-0009, ADR-0014; [point-of-sale](../domains/point-of-sale.md); [service-catalog](../implementation/service-catalog.md)
...
4. Lock pending lines and unresolved tenders; validate departments and tender settlement.
