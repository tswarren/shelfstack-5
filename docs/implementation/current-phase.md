...
**Active delivery phase:** Phase 11.1 — POS printed documents v1 (reopened)  
**Status:** **In progress** — Customer / Gift / Post-Void browser receipts delivered (gates 11.1A–D). Reopened for Stored-Value Activity Slip (11.1E) and Credit Voucher (11.1F). Phase stays open until explicitly closed. Epic [#151](https://github.com/tswarren/shelfstack-5/issues/151).

**Phase document:** [phases/phase-11.1-pos-printed-documents-v1.md](phases/phase-11.1-pos-printed-documents-v1.md)  
**Primary register:** [DWR-017](deferred-work-register.md) (receipt MVP delivered; SV Activity Slip + Credit Voucher in active 11.1 delivery; cash-movement / internal post-void / INV-POS-014 / ESC/POS remain residual)
...
1. Complete Phase 11.1 gates **11.1E** (Stored-Value Activity Slip) and **11.1F** (Credit Voucher) — do not mark the phase closed until explicitly directed.
...
10. DWR-017 residuals after 11.1E/F (cash-movement slips, internal Post-Void copy, INV-POS-014, ESC/POS) remain unscheduled.

## Program spine (preference)

```text
Phase 11.1 (reopened — SV Activity Slip + Credit Voucher)
...
- Phase 11.1 plan (active): [phases/phase-11.1-pos-printed-documents-v1.md](phases/phase-11.1-pos-printed-documents-v1.md)
...
- Active scratch: [../temp_draft/phase-11/](../temp_draft/phase-11/README.md) (correction packet); [../temp_draft/phase-11.1/](../temp_draft/phase-11.1/) (printing background; SV slip/voucher drafts)
