...
**Active delivery phase:** Phase 10 — Product record and form workflow refinement  
**Status:** In progress — Gates 10a–10d core; Gate 10e should-have  
...
**Post-core status wording (use when 10a–10d accepted and 10e remains open):**
...
1. Deliver Phase 10 core gates **10a → 10b → 10c / 10d** (10c and 10d after 10b).
2. Gate **10e** (inline creator creation) is should-have; core exit does not wait on it.
...
7. Do not pull customer-receipt product design or hardware printing into near-term work (DWR-017).
...
10. Leave DWR-029 (request-coverage extraction from product hub) unscheduled — Phase 10 must not deepen coverage-formula ownership in Catalog.
...
- New operational screens under Phase 10 when a link destination is missing (omit or nearest existing surface).
