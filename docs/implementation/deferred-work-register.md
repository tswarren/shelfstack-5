...
| DWR-010 | 6.5e — Keyboard and scanner stabilization | 6.5 | delivery_debt | [phase-11…](phases/phase-11-pos-shell-and-workspace-revamp.md) Gate E; [phase-06.5…](phases/phase-06.5-cashier-workspace.md) | Absorbed by Gate 11E | 11 | [#51](https://github.com/tswarren/shelfstack-5/issues/51); [#135](https://github.com/tswarren/shelfstack-5/issues/135) |
...
| DWR-017 | Customer receipt product (templates, gift receipts, ESC/POS / printer queues) | 7 park / 11 | delivery_debt | [phase-11…](phases/phase-11-pos-shell-and-workspace-revamp.md) Gate D; [phase-7-optional-receipt-printing.md](../temp_draft/phase-7-optional-receipt-printing.md) (non-governing) | **Phase 11 Must:** receipt presentation, basic printable receipt, lookup, reprint. **Should (may re-register):** gift/SV slips, richer variants. **Later:** ESC/POS fleets / queues | 11 (core); later_extensions (hardware) | [#134](https://github.com/tswarren/shelfstack-5/issues/134) |
...
| DWR-028 | Product import `return_to`: reject malformed percent-encoding before post-commit redirect | 8c | delivery_debt | [#112](https://github.com/tswarren/shelfstack-5/pull/112) re-review P3; [pre-Phase 11 maintenance brief](../temp_draft/phase-11/00-pre-phase-11-maintenance.md) — not a Phase 11 gate | Parse nested query inside `sanitize_return_to`; rescue `ArgumentError` in `return_path`; add controller test | unscheduled | [#116](https://github.com/tswarren/shelfstack-5/issues/116) |
...
| DWR-064 | Harden `BuildNormalizedResult` publication_date input boundary | 8d | delivery_debt | Gate 8d / OD-P8-10 re-review; [pre-Phase 11 maintenance brief](../temp_draft/phase-11/00-pre-phase-11-maintenance.md) — not a Phase 11 gate | Accept only `Date` / date-time / ISO day strings; reject duck-typed `to_date`; unit tests | unscheduled | [#120](https://github.com/tswarren/shelfstack-5/issues/120) |
...
Catalog / Phase 8 follow-on:   DWR-020 … DWR-029, DWR-064, DWR-065 (021 / 8.5 unscheduled; 024 deferred; 8e–8g unscheduled; DWR-029 unscheduled)
