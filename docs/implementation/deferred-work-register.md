...
| DWR-017 | Customer receipt product (templates, gift receipts, ESC/POS / printer queues) | 7 park / 11 | delivery_debt | Gate 11D Must in progress — browser-printable HTML receipt + lookup/reprint (`customer_receipt`). [phase-11…](phases/phase-11-pos-shell-and-workspace-revamp.md) | **Delivered (Must path):** presentation, browser-printable HTML, lookup, reprint marked REPRINT. **Should residual:** gift/SV slips, richer variants, barcode, linked-return from lookup. **Later:** ESC/POS fleets / queues | 11 (Must); later_extensions (Should/hardware) | [#134](https://github.com/tswarren/shelfstack-5/issues/134) |
