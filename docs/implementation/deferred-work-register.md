...
| DWR-020 | Searchable record-picker / nested combobox (shared linking UX) | 4f | delivery_debt | Gate 8a foundation complete pending merge ([#95](https://github.com/tswarren/shelfstack-5/issues/95)); design [interaction-patterns.md](../design/interaction-patterns.md) | Close [#95](https://github.com/tswarren/shelfstack-5/issues/95) on merge; keep row open for PO/receipt nested line adoption | Phase 8 | [#95](https://github.com/tswarren/shelfstack-5/issues/95) (foundation); follow-on TBD |
