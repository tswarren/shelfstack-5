...
| DWR-005 | Post-settlement post-void correction (replace OD-014 interim block) | 6 | interim_block | [phase-06-inventory-correction-and-od-014.md](decisions/phase-06-inventory-correction-and-od-014.md); parallel design with Phase 11 | Correction Integrity Design Packet | unscheduled | — |
| DWR-006 | Return-containing post-void | 6 | interim_block | [phase-06-post-void-eligibility-and-cross-domain-reversal.md](decisions/phase-06-post-void-eligibility-and-cross-domain-reversal.md); parallel design with Phase 11 | Correction Integrity Design Packet | unscheduled | — |
...
| DWR-010 | 6.5e — Keyboard and scanner stabilization | 6.5 / 11 | delivery_debt | Resolved via Gate 11E — POS shell keyboard/scanner/focus/live-region contracts + Recovery restore coverage. Closes [#51](https://github.com/tswarren/shelfstack-5/issues/51) with [#135](https://github.com/tswarren/shelfstack-5/issues/135) | — | — | [#51](https://github.com/tswarren/shelfstack-5/issues/51); [#135](https://github.com/tswarren/shelfstack-5/issues/135) |
...
| DWR-017 | Customer receipt product (templates, gift receipts, ESC/POS / printer queues) | 7 park / 11 | delivery_debt | Gate 11D Must delivered on [#150](https://github.com/tswarren/shelfstack-5/pull/150) / phase-11 §15.1. [phase-11…](phases/phase-11-pos-shell-and-workspace-revamp.md) | **Delivered Must:** read-only Receipt (`pos/receipt/*`), browser-printable HTML, snapshot line description/identifier, store header/footer+address, lookup, reprint/`REPRINT` + `pos.receipt.reprint`, non-mutating lookup, print/display does not reverse completion. **Delivered Should (partial):** linked return from Receipt Lookup; return/mixed/post-void document banners; discount/net merchandise rows (on top of Must minimal print formatting). **Should residual (explicit):** non-itemized gift receipt; dedicated SV issue/reload slip; fuller return/mixed/post-void templates; receipt-number barcode/QR; expanded template administration beyond the basic printable HTML layout; INV-POS-014 persisted print-event audit (browser reprint works without it today). **Header/footer admin UI:** DWR-019. **Later:** ESC/POS fleets / queues | later_extensions (Should residual + hardware) | [#134](https://github.com/tswarren/shelfstack-5/issues/134) |
...
| DWR-020 | Searchable record-picker / nested combobox (shared linking UX) | 4f / 11 | delivery_debt | Gate 8a foundation merged (PR [#102](https://github.com/tswarren/shelfstack-5/pull/102)); [phase-11…](phases/phase-11-pos-shell-and-workspace-revamp.md) Gate B may reuse patterns for POS-native Product lookup; design [interaction-patterns.md](../design/interaction-patterns.md) | **Phase 11:** POS lookup adoption only. Residual: PO/receipt nested-line adoption | 11 (POS); unscheduled (purchasing/receiving) | [#95](https://github.com/tswarren/shelfstack-5/issues/95) (foundation, closed); [#132](https://github.com/tswarren/shelfstack-5/issues/132) |
...
| DWR-067 | POS shell and workspace revamp (Phase 11) | 11 | delivery_debt | [phase-11-pos-shell-and-workspace-revamp.md](phases/phase-11-pos-shell-and-workspace-revamp.md); archived drafts under [phase-11-drafts-2026-07-26](../archive/phase-11-drafts-2026-07-26/README.md) | Deliver Gates 11A–11E; absorb DWR-010; stage DWR-017 Must into Gate D; POS portion of DWR-020 into Gate B | 11 | [#130](https://github.com/tswarren/shelfstack-5/issues/130) |
