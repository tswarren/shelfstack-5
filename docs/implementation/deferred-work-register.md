...
| DWR-004 | Posted-receipt correction workflow | 5–6 | interim_block | [current-phase.md](current-phase.md) parallel design; OD-014 non-goals; [inventory costing design note](design-notes/inventory-costing/inventory_workflow_costing_design_note.md) | Correction Integrity Design Packet (with 005/006); then implement | unscheduled | — |
| DWR-005 | Post-settlement post-void correction (replace OD-014 interim block) | 6 | interim_block | [phase-06-inventory-correction-and-od-014.md](decisions/phase-06-inventory-correction-and-od-014.md); parallel design after Phase 11 | Correction Integrity Design Packet | unscheduled | — |
| DWR-006 | Return-containing post-void | 6 | interim_block | [phase-06-post-void-eligibility-and-cross-domain-reversal.md](decisions/phase-06-post-void-eligibility-and-cross-domain-reversal.md); parallel design after Phase 11 | Correction Integrity Design Packet | unscheduled | — |
...
| DWR-010 | 6.5e — Keyboard and scanner stabilization | 6.5 / 11 | delivery_debt | Resolved 2026-07-27 via Gate 11E on [#146](https://github.com/tswarren/shelfstack-5/pull/146) / [#150](https://github.com/tswarren/shelfstack-5/pull/150) — POS shell keyboard/scanner/focus/live-region contracts + Recovery restore coverage. Closes [#51](https://github.com/tswarren/shelfstack-5/issues/51) with [#135](https://github.com/tswarren/shelfstack-5/issues/135) | — | — | [#51](https://github.com/tswarren/shelfstack-5/issues/51); [#135](https://github.com/tswarren/shelfstack-5/issues/135) |
...
| DWR-017 | Customer receipt product (templates, gift receipts, ESC/POS / printer queues) | 7 park / 11 / 11.1 | delivery_debt | Gate 11D Must on [#150](https://github.com/tswarren/shelfstack-5/pull/150); Phase 11.1 [phase-11.1…](phases/phase-11.1-pos-printed-documents-v1.md); epic [#151](https://github.com/tswarren/shelfstack-5/issues/151) | **Delivered (Phase 11 + 11.1A–D):** Receipt workspace; Customer/Gift/Post-Void browser docs; `gift_receipt_footer`; Code 128; server-owned immediate/reprint routes; masked customer; VOIDED originals; Store receipt text fields. **In delivery (11.1E–F):** SV Activity Slip; Credit Voucher; `stored_value.activity.print` / `stored_value.voucher.print`. **Residual:** Cash Movement slips; internal Post-Void copy; INV-POS-014; expanded template admin; ESC/POS fleets. **Fuller settings UI:** DWR-019 | Phase 11.1 (SV print reopen); later_extensions (residual + hardware) | [#151](https://github.com/tswarren/shelfstack-5/issues/151) |
...
| DWR-019 | Organization / store settings UI gap (address, SAN, card grain, org defaults) | 1 / 7 | delivery_debt | Store schema + strong params; Phase 11.1 exposed receipt header/footer/gift footer on Store form; address/SAN/org settings UI still thin | DWR-001 for behavioral settings home | unscheduled | — |
| DWR-020 | Searchable record-picker / nested combobox (shared linking UX) | 4f / 11 | delivery_debt | Gate 8a foundation merged (PR [#102](https://github.com/tswarren/shelfstack-5/pull/102)); Phase 11 Gate B POS-native Product lookup delivered on [#146](https://github.com/tswarren/shelfstack-5/pull/146) / [#150](https://github.com/tswarren/shelfstack-5/pull/150); design [interaction-patterns.md](../design/interaction-patterns.md) | **Delivered (Phase 11):** POS lookup adoption. **Residual:** PO/receipt nested-line adoption | unscheduled (purchasing/receiving) | [#95](https://github.com/tswarren/shelfstack-5/issues/95) (foundation, closed); [#132](https://github.com/tswarren/shelfstack-5/issues/132) (Gate B closed) |
| DWR-021 | Multi-variant unlock (`single` / `named`) | 2 | catalog_candidate | OD-P8-07 accepted direction; delivery deferred — [phase-08…v1](decisions/phase-08-catalog-refinement-and-enrichment-v1.md). Named vehicle remains Phase 8.5 when scheduled | Cross-domain packet before schema unlock; leave unscheduled for now | unscheduled | — |
| DWR-022 | Bibliographic enrichment — enrich existing product (Gate 8f) | — | delivery_debt | OD-P8-01, 04, 09, 10 accepted — [phase-08…v1](decisions/phase-08-catalog-refinement-and-enrichment-v1.md). Gates 8b–8c create-from-ISBN done; Phase 8 closed after Must gates — enrich-existing deferred | Provider credentials; field-level apply / conflict UX | unscheduled | [#100](https://github.com/tswarren/shelfstack-5/issues/100) |
| DWR-023 | Product images / subjects / DQ views (Gate 8g remainder) | — | delivery_debt | Creators OD-P8-02 delivered in Gate 8b Slice 1; images OD-P8-03 + subjects/DQ remain [phase-08…v1](decisions/phase-08-catalog-refinement-and-enrichment-v1.md). Phase 8 closed — optional 8g deferred | Images only when `remote_display_permitted`+ | unscheduled | [#101](https://github.com/tswarren/shelfstack-5/issues/101) |
...
| DWR-027 | BISAC / external subject → merchandise class mapping | — | delivery_debt | OD-P8-05 accepted — [phase-08…v1](decisions/phase-08-catalog-refinement-and-enrichment-v1.md). Phase 8 closed — optional 8g deferred | Optional Gate 8g | unscheduled | [#101](https://github.com/tswarren/shelfstack-5/issues/101) |
| DWR-028 | Product import `return_to`: reject malformed percent-encoding before post-commit redirect | 8c | delivery_debt | Resolved in [#137](https://github.com/tswarren/shelfstack-5/pull/137) — nested-query sanitize + `return_path` rescue; closes [#116](https://github.com/tswarren/shelfstack-5/issues/116) | — | — | [#116](https://github.com/tswarren/shelfstack-5/issues/116) |
| DWR-029 | Extract batched Product Request coverage from Catalog product hub | 8d | delivery_debt | Gate 8d re-review — `Catalog::BuildProductSummary` correctly batches coverage but duplicates `ProductRequest` formulas | Move projection to `Requests::BuildCoverageSnapshots` (or equivalent); Catalog assembles hub only; keep query-bound test | unscheduled | [#119](https://github.com/tswarren/shelfstack-5/issues/119) |
...
Phase 6.5 / 7 carry-forward:   DWR-011 … DWR-019 (DWR-010 resolved with Phase 11E)
Catalog / Phase 8 follow-on:   DWR-020 residual (purchasing/receiving) … DWR-027, DWR-029, DWR-065 (021 / 8.5 unscheduled; 024 deferred; 8e–8g unscheduled; DWR-028/064 resolved in #137)
Phase 10 follow-on:            DWR-066 (triggered invariant — before independent receipt/PO/cost roles)
Phase 11 (closed):             DWR-067 resolved
Phase 11.1 (reopened):         DWR-017 receipt MVP delivered; SV Activity Slip + Credit Voucher in 11.1E–F; residual cash-movement/audit/ESC/POS remain
...
Delivery Phase 8 **Catalog refinement & enrichment** is **closed** (Must gates 8a–8d). Remaining Should/Nice catalog work lives on this register ([phase plan](phases/phase-08-catalog-refinement-and-enrichment.md)). [deferred-capabilities.md](deferred-capabilities.md) is **later extensions** (not Phase 8).

- treat leftover catalog rows (including DWR-021 / Phase 8.5) as unscheduled until explicitly pulled;
