...
| DWR-020 | Searchable record-picker / nested combobox (shared linking UX) | 4f | delivery_debt | Phase 8 gate 8a; [phase-08…v1](decisions/phase-08-catalog-refinement-and-enrichment-v1.md); design [interaction-patterns.md](../design/interaction-patterns.md) | PO/receipt nested line adoption is follow-on (not 8a exit) | Phase 8 | [#95](https://github.com/tswarren/shelfstack-5/issues/95) |
