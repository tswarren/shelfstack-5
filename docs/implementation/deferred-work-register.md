...
| DWR-017 | Customer receipt product (templates, gift receipts, ESC/POS / printer queues) | 7 park / 11 / 11.1 | delivery_debt | Gate 11D Must on [#150](https://github.com/tswarren/shelfstack-5/pull/150); Phase 11.1 [phase-11.1…](phases/phase-11.1-pos-printed-documents-v1.md); epic [#151](https://github.com/tswarren/shelfstack-5/issues/151) | **Delivered (Phase 11 + 11.1A–F):** Receipt workspace; Customer/Gift/Post-Void browser docs; SV Activity Slip; Credit Voucher; `gift_receipt_footer`; Code 128; server-owned immediate/reprint routes; masked customer; VOIDED originals; Store receipt text fields; `stored_value.activity.print` / `stored_value.voucher.print`. **Residual:** Cash Movement slips; internal Post-Void copy; INV-POS-014; expanded template admin; ESC/POS fleets. **Fuller settings UI:** DWR-019 | later_extensions (residual + hardware) | [#151](https://github.com/tswarren/shelfstack-5/issues/151) |
