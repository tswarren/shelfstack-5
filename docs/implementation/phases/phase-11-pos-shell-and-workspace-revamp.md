...
**Status:** In progress — server gates 11A–11E delivered ([#146](https://github.com/tswarren/shelfstack-5/pull/146)); layout Gates L0–L7 + Ready fixes in [#150](https://github.com/tswarren/shelfstack-5/pull/150) (`feat/phase-11-layout`); viewport acceptance pending ([layout-acceptance-status.md](../../design/pos/layout-acceptance-status.md))  
...
Epic and gate issues (filed):

| Issue | Title |
| --- | --- |
| [#130](https://github.com/tswarren/shelfstack-5/issues/130) | Phase 11 — POS Shell and Workspace Revamp (epic) |
| [#131](https://github.com/tswarren/shelfstack-5/issues/131) | 11A — Stable register foundation |
| [#132](https://github.com/tswarren/shelfstack-5/issues/132) | 11B — Complete transaction entry |
| [#133](https://github.com/tswarren/shelfstack-5/issues/133) | 11C — Financial completion |
| [#134](https://github.com/tswarren/shelfstack-5/issues/134) | 11D — Customer-facing completion (receipt core) |
| [#135](https://github.com/tswarren/shelfstack-5/issues/135) | 11E — Release readiness (absorbs DWR-010 / [#51](https://github.com/tswarren/shelfstack-5/issues/51)) |
...
1. [x] Add Phase 11 to `roadmap.md`.
2. [x] Set `current-phase.md` to Phase 11 — scheduled.
3. [x] Set DWR-067 target to Phase 11; link epic [#130](https://github.com/tswarren/shelfstack-5/issues/130).
4. [x] Point DWR-010 to Gate E ([#135](https://github.com/tswarren/shelfstack-5/issues/135) / [#51](https://github.com/tswarren/shelfstack-5/issues/51)).
5. [x] Split DWR-017 into Gate D mandatory receipt core; Should-level receipt variants; later printer infrastructure.
6. [x] Point only the POS portion of DWR-020 to Gate B ([#132](https://github.com/tswarren/shelfstack-5/issues/132)).
7. [x] Record DWR-066 as a triggered authorization invariant.
8. [x] List DWR-004–006 as parallel design work in `current-phase.md`.
9. [x] Keep DWR-001/018/019 conditional.
10. [x] Keep DWR-028/064 outside the dependency tree (maintenance brief under `temp_draft/phase-11/`).
11. [x] Archive former Phase 11 stub, sequencing, and prioritization drafts (`docs/archive/phase-11-drafts-2026-07-26/`).
12. [x] Retain the Deferred-Work Prioritization Matrix as archived planning projection (not governing).
