# Delivery Phase Documents

Each phase document defines goals, principal tables, services, exit criteria, and out-of-scope items for that delivery slice.

| Phase | Document |
| --- | --- |
| 0 | [phase-00-scaffold-and-locks.md](phase-00-scaffold-and-locks.md) |
| 1 | [phase-01-organization-and-authorization.md](phase-01-organization-and-authorization.md) |
