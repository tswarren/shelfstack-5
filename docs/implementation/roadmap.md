...
| 11.1 | POS printed documents v1 | Complete — gates 11.1A–F on `main` (via [#157](https://github.com/tswarren/shelfstack-5/pull/157)); epic [#151](https://github.com/tswarren/shelfstack-5/issues/151) closed; residuals on DWR-017 | [phases/phase-11.1-pos-printed-documents-v1.md](phases/phase-11.1-pos-printed-documents-v1.md) |
| 11.2 | Register workflow refinement | Complete — [#168](https://github.com/tswarren/shelfstack-5/pull/168); epic [#158](https://github.com/tswarren/shelfstack-5/issues/158) | [phases/phase-11.2-register-workflow-refinement.md](phases/phase-11.2-register-workflow-refinement.md) |
| 11.3 | POS Operations workspace | Active — epic [#165](https://github.com/tswarren/shelfstack-5/issues/165); gates [#169](https://github.com/tswarren/shelfstack-5/issues/169)–[#173](https://github.com/tswarren/shelfstack-5/issues/173) | [phases/phase-11.3-pos-operations-workspace.md](phases/phase-11.3-pos-operations-workspace.md) |
| 11.4 | POS policy and lifecycle hardening | Scheduled — epic [#166](https://github.com/tswarren/shelfstack-5/issues/166); after 11.3 | [phases/phase-11.4-pos-policy-and-lifecycle-hardening.md](phases/phase-11.4-pos-policy-and-lifecycle-hardening.md) |
...
| — | Delivery Phase 11.1 | POS printed documents v1 |
| — | Delivery Phase 11.2 | Register workflow refinement |
| — | Delivery Phase 11.3 | POS Operations workspace |
| — | Delivery Phase 11.4 | POS policy and lifecycle hardening |
...
**Active:** Phase 11.3 POS Operations workspace ([phase plan](phases/phase-11.3-pos-operations-workspace.md); [current-phase.md](current-phase.md); epic [#165](https://github.com/tswarren/shelfstack-5/issues/165)) — gates 11.3A–E ([#169](https://github.com/tswarren/shelfstack-5/issues/169)–[#173](https://github.com/tswarren/shelfstack-5/issues/173)).

**Scheduled:** Phase 11.4 ([#166](https://github.com/tswarren/shelfstack-5/issues/166)).

Completed: Phases 0–11 core delivery; Phase 11.2 Register workflow ([#168](https://github.com/tswarren/shelfstack-5/pull/168)); Phase 11.1 gates 11.1A–F (Customer/Gift/Post-Void receipts + SV Activity Slip + Credit Voucher). Phase 11 POS shell ([#146](https://github.com/tswarren/shelfstack-5/pull/146) + [#150](https://github.com/tswarren/shelfstack-5/pull/150); `ddb85cb`). Phase 10 product record/form refinement (Gates 10a–10e) in PR [#128](https://github.com/tswarren/shelfstack-5/pull/128). Phase 9 Customer records merged to `main` at `db6778d` (PR [#122](https://github.com/tswarren/shelfstack-5/pull/122)). Phase 8 Must 8a–8d closed; Should/Nice 8e–8g deferred. Phase 7 at `d27d666` (PR [#62](https://github.com/tswarren/shelfstack-5/pull/62); 7e partial [#94](https://github.com/tswarren/shelfstack-5/issues/94)). Phase 6.5 at `bd7fb9d` (PR [#54](https://github.com/tswarren/shelfstack-5/pull/54)). Phase 6 at `853ae3b` (PR [#39](https://github.com/tswarren/shelfstack-5/pull/39)). Phase 5 at `2e3e119` (PR #34).

**Carry-forward backlog:** [deferred-work-register.md](deferred-work-register.md) (open decisions, interim correction blocks, Phase 7 follow-ups [#89](https://github.com/tswarren/shelfstack-5/issues/89)–[#94](https://github.com/tswarren/shelfstack-5/issues/94), Phase 8 Should/Nice follow-on, Phase 10 follow-on DWR-066, DWR-017 residuals after 11.1, DWR-020 purchasing/receiving picker residual, full CRM beyond Customer v1 (DWR-036), later extensions). DWR-021 (multi-variant) and DWR-029 (request-coverage extraction) remain unscheduled. OD-P11-01–04 accepted (check refund + Operations boundaries) — apply in Phase 11.3 / 11.4.
...
5. Refund allocation remains **stored-value first** ([phase-11.2-refund-allocation-sv-first.md](decisions/phase-11.2-refund-allocation-sv-first.md)).
