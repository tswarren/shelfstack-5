...
| 10 | Product record and form workflow refinement | In progress — core gates 10a–10d; Gate 10e should-have | [phases/phase-10-product-record-and-form-refinement.md](phases/phase-10-product-record-and-form-refinement.md) |
...
**Active:** Delivery Phase 10 — Product record and form workflow refinement ([phase doc](phases/phase-10-product-record-and-form-refinement.md); [current-phase.md](current-phase.md)). Core gates 10a–10d; Gate 10e should-have. After core acceptance use: `Core complete — Gates 10a–10d accepted; Gate 10e deferred`.
...
**Carry-forward backlog:** [deferred-work-register.md](deferred-work-register.md) (open decisions, interim correction blocks, Phase 7 follow-ups [#89](https://github.com/tswarren/shelfstack-5/issues/89)–[#94](https://github.com/tswarren/shelfstack-5/issues/94), Phase 8 Should/Nice follow-on, full CRM beyond Customer v1 (DWR-036), later extensions). DWR-021 (multi-variant) and DWR-029 (request-coverage extraction) remain unscheduled during Phase 10.

1. Deliver Phase 10 core (10a–10d); track 10e separately if deferred.
