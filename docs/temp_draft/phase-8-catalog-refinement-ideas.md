...
**Status:** Non-governing planning draft
**Date:** 2026-07-24
**Depends on:** Phase 7 core complete
**Roadmap position:** Next delivery phase after Phase 7
**Governing documents:** ADR-0001, ADR-0002, ADR-0003; [catalog-and-products](../domains/catalog-and-products.md); [architectural-locks](../implementation/architectural-locks.md)
**Carry-forward register:** [deferred-work-register.md](../implementation/deferred-work-register.md)
...
**Open decisions queue:** [open-decisions.md](../implementation/open-decisions.md) (OD-P8-01…10)  

Promote this document to:

```text
docs/implementation/phases/phase-08-catalog-refinement-and-enrichment.md
```

when ready to implement. Operating decisions OD-P8-01…10 are already accepted (see decision note).
...
**Disposition:** OD-P8-01 through OD-P8-10 are recorded in [open-decisions.md](../implementation/open-decisions.md). Full text: [phase-08-catalog-refinement-and-enrichment-v1.md](../implementation/decisions/phase-08-catalog-refinement-and-enrichment-v1.md).
...
## 19. Suggested promotion path

1. ~~Review and accept Phase 8 core boundaries / OD-P8-01…10~~ — done ([decision note](../implementation/decisions/phase-08-catalog-refinement-and-enrichment-v1.md)).
2. Promote this draft into `docs/implementation/phases/phase-08-catalog-refinement-and-enrichment.md`.
3. Update `roadmap.md` so the Phase 8 row links to the promoted plan.
4. Update `current-phase.md` with Gate 8a as the first implementation target.
5. Keep DWR-021 multi-variant targeted to Phase 8.5; DWR-024 publisher party deferred.
6. Create GitHub issues only for accepted, branch-sized gate work.
7. Begin implementation with shared linking controls (8a), then bibliographic/provider foundation and create-from-ISBN (8b–8c).
